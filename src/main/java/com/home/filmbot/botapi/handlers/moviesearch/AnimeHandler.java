...
@Slf4j
@Component
public class AnimeHandler implements InputMessageHandler {
    private final ReplyMessagesService messagesService;
    private final MenuService menuService;

    public AnimeHandler(ReplyMessagesService messagesService, MenuService menuService) {
    ...
    public SendMessage handle(Message message) {
        if (message.getText().equals("Аниме")) {
